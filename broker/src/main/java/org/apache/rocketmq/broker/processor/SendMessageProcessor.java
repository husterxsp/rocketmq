...
//        设置delayLevel
        ...
        // 超过最大重试次数之后，放入死信队列。%DLQ%+consumerGroup
        // 死信队列需要人工干预
...
//        消息丢回commitlog
    ...
    private RemotingCommand sendMessage(final ChannelHandlerContext ctx,
        ...
        // 标识RPC的seq number，以便于客户端对应起来之后，去处理。
